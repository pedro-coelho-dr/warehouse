...
INSERT INTO pedido (valor, desconto, quantidade, status, fk_funcionario_id, fk_produto_id, fk_cliente_id) VALUES
                                                                                                  (475.00, 25.00, 10, 'Em Andamento', 2, 1, 1),
                                                                                                  (90.00, 0.00, 5, 'Finalizado', 2, 2, 1);

INSERT INTO venda (fk_pedido_id) VALUES
    (2);

INSERT INTO aluguel (dt_devolucao, fk_pedido_id, status) VALUES
    ('2024-07-15', 1, 'Não Devolvido');
